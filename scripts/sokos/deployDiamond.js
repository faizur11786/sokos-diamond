...
async function main () {
  ...
  const sokosDiamond = await SokosDiamond.deploy(contractOwner.address, diamondCutFacet.address)
  ...
  const diamondCut = await ethers.getContractAt('IDiamondCut', sokosDiamond.address)
  let tx
  let receipt
